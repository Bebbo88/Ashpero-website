  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="relative group">
        ...
        <Link href="/cart" className="relative flex items-center justify-center w-14 h-14 bg-bg-secondary border border-border-color rounded-full shadow-lg hover:bg-brand-orange hover:text-white hover:border-brand-orange text-text-primary transition-all hover:scale-110 active:scale-95 group">
      ...
      <motion.div variants={itemVariants}>
        <button 
          onClick={() => alert("AI Skincare Doctor initiating...\n(This will open the AI Chat window)")}
          className="relative flex items-center justify-center w-16 h-16 bg-gradient-to-br from-brand-mint to-brand-dark text-white rounded-full shadow-[0_8px_30px_rgba(105,181,120,0.5)] border-2 border-white/20 hover:shadow-[0_8px_30px_rgba(105,181,120,0.8)] transition-all hover:scale-110 active:scale-95 group"
